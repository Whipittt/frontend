...
export const RecipeCardSm: React.FC<RecipeCardProps> = ({ recipe }) => {
  const imgSrc =
    recipe?.display_image ?? "https://via.placeholder.com/300?text=No+image";
...
export const RecipeCardLg: React.FC<RecipeCardProps> = ({ recipe }) => {
  const imgSrc =
